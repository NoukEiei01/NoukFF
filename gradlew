...
# KEY FIX: single-quoted so the embedded double-quotes are literal
# This is the exact format the GradleWrapperMain launcher expects
...
# eval correctly word-splits the double-quoted flags inside DEFAULT_JVM_OPTS
